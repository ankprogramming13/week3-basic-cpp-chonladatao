...
int main() {
  // เขียนโปรแกรมเพิ่ม เพื่อหาขนาดตัวแปรที่กำหนด
   ...
   cout << "Min of short unsigned char : " << numeric_limits<unsigned char>::min() << endl;
   cout << "Max of short unsigned char : " << numeric_limits<unsigned char>::max() << endl;

   cout << "Min of short int : " << numeric_limits<int>::min() << endl;
   cout << "Max of short int : " << numeric_limits<int>::max() << endl;

   cout << "Min of short signed int : " << numeric_limits<signed int>::min() << endl;
   cout << "Max of short signed int : " << numeric_limits<signed int>::max() << endl;

   cout << "Min of short unsigned int : " << numeric_limits<unsigned int>::min() << endl;
   cout << "Max of short unsigned int : " << numeric_limits<unsigned int>::max() << endl;

   cout << "Min of short short int : " << numeric_limits<short int>::min() << endl;
   cout << "Max of short short int : " << numeric_limits<short int>::max() << endl;

   cout << "Min of short signed short int : " << numeric_limits<signed short int>::min() << endl;
   cout << "Max of short signed short int : " << numeric_limits<signed short int>::max() << endl;
